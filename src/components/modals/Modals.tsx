import { Modal, Alert, Button, TreeSelect, Typography, Spin, Upload, Input, Select } from "antd";
import { LinkOutlined, CalendarOutlined, UploadOutlined, DatabaseOutlined } from "@ant-design/icons";
...
export const NexHealthLeadFormModal: React.FC<ModalProps> = ({ open, status, accountInfo, onOk, onCancel, onConnect }) => {
