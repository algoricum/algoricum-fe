...
import { useClinicData, useLeads, useTwilioConfig } from "@/hooks/useDashboard";
...
import { AppointmentFilter, IntegrationBannersProps, LOADING_DELAY } from "./types";
      ...
      <div className="flex items-center gap-4">
        <div className="rounded-lg p-3 bg-orange-100 border border-orange-200">
          <svg
            ...
            className="text-orange-600 lucide lucide-message-circle-dashed-icon lucide-message-circle-dashed"
          >
